	<title>CodeHive: Outsource</title>
	<style type="text/css">
	#body-sec{
		padding-top: 40px;
		height:600px;
...
<body>
	...
	<header>
		...
		<nav id="navigation" class="navbar">
			<ul>
				<li><a data-toggle="modal" href="#loginModal" class="top-btn btn btn-success">Login</a></li>
				<li><a data-toggle="modal" href="#registrationModal" class="top-btn btn btn-success">Sign Up</a></li>
			</ul>
		</nav>
	</header>
	<section id="body-sec">
